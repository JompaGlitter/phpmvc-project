...
<!-- Flash important info, picture or slideshow -->
<?php if ($this->views->hasContent('flash')) : ?>
<div id='flash'><?php $this->views->render('flash')?></div>
<?php endif; ?>


<!-- Extra important content, 3 regions in section -->
...
<!-- Main content and sidebar, 2 regions in section -->
...
<!-- Important content, 3 regions in section -->
...
<!-- Useful links and info in footer, 4 regions in section -->
